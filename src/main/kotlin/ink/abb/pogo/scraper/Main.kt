    ...
    fun createBot() {
        ...
        if(names.size < 1) {
            ...
            botRunService.submitBot(Settings(
                ...
                ignoredPokemon = getPropertyIfSet(properties, "Never transfer these Pokemon", "ignored_pokemon", "EEVEE,MEWTWO,CHARMANDER", String::toString).split(",").map { PokemonId.valueOf(it) },
